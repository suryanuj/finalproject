...
//Main function, if the command line gets 2 arguments, it executes the surver part, if command line gets 3 arguments, it executes the client part.
int main(int argc, char*argv[]) {
	...
	if (argc == 2) {
		...
		//Below is to make the “S” for sent		
		clearBitmap(fb->bitmap,blank);
		...
		clearBitmap(fb->bitmap,blank);
		/* Below is to make the “R” for Recieved */
